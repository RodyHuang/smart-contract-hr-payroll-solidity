...
/// @notice This interface defines the functions that the HumanResources contract mustimplement
/// The contract must be able to register employees , terminate them , and allowemployees to withdraw their salary
/// The contract will be funded using only USDC but will pay the employees in USDC orETH
